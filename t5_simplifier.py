...
def get_command():
    ...
    parser.add_argument("--output_dir", default='models/query-simplifier-bs2-e4', type=str,
    ...
    parser.add_argument("--train_file", default='data/training_data_for_query_simplifier.jsonl', type=str,
    ...
    parser.add_argument("--cross_validate", default=True, action='store_true',
