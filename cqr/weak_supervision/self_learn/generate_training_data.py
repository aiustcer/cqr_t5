...
with open('/data3/private/fengtao/Projects/cqr_t5/data/evaluation_topics_v1.0.json', 'r') as fin:
    raw_data = json.load(fin)

with open('/data3/private/fengtao/Projects/cqr_t5/data/evaluation_topics_annotated_resolved_v1.0.tsv', 'r') as fin:
