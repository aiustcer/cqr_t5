...
from souces import QueryRewriteDataset, NUM_FOLD, set_seed, special_tokens_dict
...
def get_command():
    ...
    parser.add_argument("--output_dir", default='models/t5-rule-bs1-e4-eos', type=str,
    ...
    parser.add_argument("--train_file", default='data/weak_supervision_data/rule-based.jsonl', type=str,
